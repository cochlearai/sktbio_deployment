...
class TritonPythonModel:
    def initialize(self, args):
        ...
        # note: batch inference issue (https://huggingface.co/openai/whisper-large-v3/discussions/100)
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            inference_response = pb_utils.InferenceResponse(
                output_tensors = [
                    pb_utils.Tensor("transcribed_text", np.array([str(transcribed_text).encode()]))
                ]
            )
